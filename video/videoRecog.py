...
TOLERANCE = 0.5 # higher tolerance, more matches, but maybe more false positives
FRAME_THICKNESS = 3
FONT_THICKNESS = 2
MODEL = "cnn" # "hog" is alternative, uses more CPU

video = cv2.VideoCapture(0) # filename also accepted
